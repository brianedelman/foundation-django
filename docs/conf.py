# -*- coding: utf-8 -*-
#
# foundation CMS Guide documentation build configuration file, created by
...
htmlhelp_basename = 'foundation.doc'
...
man_pages = [
    ('index', 'foundationcmsguide', u'foundation Documentation',
...
texinfo_documents = [
  ('index', 'foundationCMSGuide', u'foundation Documentation',
   u'Christopher Clarke', 'foundationCMSGuide', 'One line description of project.',
   'Miscellaneous'),
]
